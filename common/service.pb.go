...
// Tor Multi-Exit. These messages are an internal typed Node contract; public
// Panel API models may intentionally expose fewer operational fields.
type TorLocationSpec struct {
	...
	XrayInboundPort     uint32                 `protobuf:"varint,9,opt,name=xray_inbound_port,json=xrayInboundPort,proto3" json:"xray_inbound_port,omitempty"` // 0 = automatic
	...
	TorSocksPort        uint32                 `protobuf:"varint,13,opt,name=tor_socks_port,json=torSocksPort,proto3" json:"tor_socks_port,omitempty"`       // 0 = automatic
	TorControlPort      uint32                 `protobuf:"varint,14,opt,name=tor_control_port,json=torControlPort,proto3" json:"tor_control_port,omitempty"` // 0 = automatic
...
const file_common_service_proto_rawDesc = "" +
	...
	"\x11ForceReconcileTor\x12\x0e.service.Empty\x1a\x1d.service.TorReconcileResponse\"\x00B#Z!github.com/pasarguard/node/commonb\x06proto3"
